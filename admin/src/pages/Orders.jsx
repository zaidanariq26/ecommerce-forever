		...
		<>
			<div className="space-y-6">
				...
				<div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
					...
					<button
						onClick={exportCSV}
						className="flex cursor-pointer items-center gap-1.5 rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-1.5 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
					>
				...
				{/* Bulk Action Bar */}
				{selectedIds.size > 0 && (
					<div className="flex flex-col gap-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4 sm:flex-row sm:items-center sm:justify-between">
						...
						<div className="flex items-center gap-2">
							<select
								...
								className="rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white px-3 py-1.5 text-sm"
							>
								{STATUSES.map((s) => (
							...
							<button
								...
								className="cursor-pointer rounded-lg bg-gray-900 dark:bg-gray-700 px-4 py-1.5 text-sm font-medium text-white hover:bg-gray-800 dark:hover:bg-gray-600 disabled:opacity-50 transition-colors"
							>
								{bulkLoading ? "Updating..." : "Update Status"}
							</button>
							<button
								onClick={() => setSelectedIds(new Set())}
								className="cursor-pointer rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-1.5 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
							>
								Clear
							</button>
						</div>
				...
				<div className="space-y-3">
					{orders.map((order) => (
						<div
							...
							className="cursor-pointer rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4 transition-colors hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 md:p-5"
						>
							<div className="flex flex-col gap-3 md:flex-row md:items-start">
								...
								<div className="flex flex-row flex-wrap items-center gap-2 md:w-auto md:flex-col md:items-end md:gap-2">
									...
									<select
										...
										className={`rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white px-2 py-1 text-xs ${order.status === "Delivered" ? "cursor-not-allowed opacity-50" : ""}`}
									>
										{STATUSES.map((s) => (
											<option key={s} value={s}>
												{s}
