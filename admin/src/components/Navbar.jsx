...
const Navbar = ({ setToken, token, onMenuToggle }) => {
	...
	return (
		<div className="relative lg:left-56 lg:w-[calc(100%-14rem)] flex items-center justify-between border-b border-gray-200 bg-white px-4 py-3 dark:border-gray-800 dark:bg-gray-900 sm:px-6 lg:px-8">
			{/* Left: Hamburger + Logo */}
			...
			<div className="flex items-center gap-2 sm:gap-3">
				...
				>
					<Icon
						icon={dark ? "solar:sun-outline" : "solar:moon-outline"}
						className="text-lg"
					/>
				</button>
				{/* Notification Bell */}
							...
							{pendingOrders.length === 0 && lowStockProducts.length === 0 && (
								<div className="px-4 py-8 text-center">
									<Icon
										...
										className="mx-auto mb-2 text-3xl text-green-500"
									/>
									<p className="text-sm text-gray-500 dark:text-gray-400">
										All caught up!
									</p>
