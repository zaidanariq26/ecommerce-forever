...
const Sidebar = ({ isOpen, onClose }) => {
	return (
		<>
			...
			{/* Sidebar */}
			<div
				className={`fixed top-0 left-0 z-50 h-full border-r border-gray-200 w-56 dark:border-gray-800 bg-white dark:bg-gray-900 transition-transform duration-300  lg:translate-x-0 ${
					isOpen ? "translate-x-0" : "-translate-x-full"
				}`}
			>
				{/* Logo */}
				<div className="h-[65px] flex items-center justify-center border-b border-gray-200 dark:border-gray-800">
					<img src={assets.logo} alt="Forever Store admin" className="w-28" />
				</div>
